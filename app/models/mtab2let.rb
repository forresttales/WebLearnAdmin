...
class Mtab2let < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM mtab2lets")
  end

  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE mtab2lets_id_seq RESTART WITH 1")
  end
