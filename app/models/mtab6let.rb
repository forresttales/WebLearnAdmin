...
class Mtab6let < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM mtab6lets")
  end

  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE mtab6lets_id_seq RESTART WITH 1")
  end
