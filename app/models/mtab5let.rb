...
class Mtab5let < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM mtab5lets")
  end

  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE mtab5lets_id_seq RESTART WITH 1")
  end
