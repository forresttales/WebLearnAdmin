...
class Mtab3let < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM mtab3lets")
  end

  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE mtab3lets_id_seq RESTART WITH 1")
  end
