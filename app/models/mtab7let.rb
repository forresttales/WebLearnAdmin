...
class Mtab7let < ActiveRecord::Base
  ...
  def self.dbdelete
      self.connection.execute("DELETE FROM mtab7lets")
  end

  
  def self.dbclear
      self.connection.execute("ALTER SEQUENCE mtab7lets_id_seq RESTART WITH 1")
  end
